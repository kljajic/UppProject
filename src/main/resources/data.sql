--USERS
insert into user(id, address, city, email, user_type, name, password, username, zip_code, date_round_robin) values (1, 'Ulica 6/13', 'Grad 1', 'kljajic77@gmail.com', 'FIZICKO', 'Naziv 1', 'password1', 'username1', '21000', '2000-01-01');
